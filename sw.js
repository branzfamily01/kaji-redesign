const CACHE="kaji-redesign-v2.1.2";
const ASSETS=["./","./index.html","./style.css","./v21.css","./app.js","./firebase-config.js","./cloud-bridge.js","./cloud-ui-fix.js","./manifest.webmanifest","./icon.svg"];
